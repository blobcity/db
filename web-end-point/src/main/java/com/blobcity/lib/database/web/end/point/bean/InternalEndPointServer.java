...
/**
 * This class acts as the loader for the web endpoint for dbint.blobcity.com
 *
 * @author javatarz (Karun Japhet)
 * @author sanketsarang
 */
@Component
public class InternalEndPointServer {

    private static final Logger logger = LoggerFactory.getLogger(InternalEndPointServer.class);
