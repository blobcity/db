 ...
 * satisfies all files that satisfy greater-than operator with reference value.
 *
 * @author sanketsarang
 * @param <T>
 */
public class GTFilenameFilter<T extends Comparable<T>> implements OperatorFileFilter {

    private final TypeConverter<T> typeConverter;
    private final T referenceValue;

    public GTFilenameFilter(TypeConverter<T> typeConverter, T referenceValue) {
