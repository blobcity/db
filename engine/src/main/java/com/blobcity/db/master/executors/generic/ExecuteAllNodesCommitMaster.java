 ...
 * @author sanketsarang
 */
public class ExecuteAllNodesCommitMaster extends AbstractCommitMaster implements MasterExecutable, Callable<Query> {

    public ExecuteAllNodesCommitMaster(Query query) {
        super(query);
    }
}
