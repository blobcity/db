...
import com.blobcity.db.master.executors.data.RemoveMaster;
...
@Component
@Deprecated
public class BQueryRemoveExecutor {

    @Autowired
    private MasterStore masterStore;

    public JSONObject execute(JSONObject queryJson) throws OperationException {
        BQueryRemoveStatement bQueryRemoveStatement = BQueryRemoveStatement.fromJson(queryJson);
        return execute(bQueryRemoveStatement);
    }

    public JSONObject execute(BQueryRemoveStatement bQueryRemoveStatement) throws OperationException {
...
//         *
//        if (bQueryRemoveStatement.getPk() == null) {
//            throw new OperationException(ErrorCode.INTERNAL_OPERATION_ERROR, "Primary key value has to be set in "
//                    + "internal execution layer for remove to succeed");
//        }
//        *
//        */
//
//        MasterExecutable masterExecutable = new RemoveMaster(bQueryRemoveStatement);
