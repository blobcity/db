 ...
 * @author sanketsarang
 */
public class BQuerySelectStatement implements Jsonable {
    
    private String app;
    private String table;
    private String pk;
    
    public BQuerySelectStatement() {
        //do nothing
    }
    
    public BQuerySelectStatement(final String app, final String table, final String pk) {
        this.app = app;
        this.table = table;
        this.pk = pk;
    }
    ...
    public JSONObject toJson() {
        ...
        jsonObject.put(BQueryParameters.QUERY, BQueryCommands.SELECT.getCommand());
        jsonObject.put(BQueryParameters.PRIMARY_KEY, pk);
        return jsonObject;
    }

    public static BQuerySelectStatement fromJson(JSONObject jsonObject) {
        BQuerySelectStatement bQuerySelectStatement = new BQuerySelectStatement();
