...
import com.blobcity.db.master.executors.data.UpdateMaster;
...
@Component
@Deprecated
public class BQueryUpdateExecutor {

    @Autowired
    private MasterStore masterStore;

    public JSONObject execute(JSONObject queryJson) throws OperationException {
        BQueryUpdateStatement bQueryInsertStatement = BQueryUpdateStatement.fromJson(queryJson);
        return execute(bQueryInsertStatement);
    }

    public JSONObject execute(BQueryUpdateStatement bQueryUpdateStatement) throws OperationException {
...
//         *
//        if (bQueryUpdateStatement.getPk() == null) {
...
//        */
//
//        MasterExecutable masterExecutable = new UpdateMaster(bQueryUpdateStatement);
