 ...
 * @author sanketsarang
 */
public class InsertTransaction implements HookTransaction {
    private final JSONObject jsonObject;

    public InsertTransaction(final String ds, final String collection, final JSONObject record) {
    ...
    public InsertTransaction(final String ds, final String collection, List<JSONObject> records) {
        jsonObject = new JSONObject();
        jsonObject.put(Protocol.TYPE.key(), Protocol.TRANSACTION_HOOK.key());
        jsonObject.put(Protocol.EVENT.key(), Protocol.INSERT_EVENT.key());
        jsonObject.put(Protocol.DS.key(), ds);
