 ...
 * @author sanketsarang
 */
public class DeleteTransaction implements HookTransaction {
    private final JSONObject jsonObject;

    public DeleteTransaction(final String ds, final String collection, final JSONObject record) {
    ...
    public DeleteTransaction(final String ds, final String collection, List<JSONObject> records) {
        jsonObject = new JSONObject();
        jsonObject.put(Protocol.TYPE.key(), Protocol.TRANSACTION_HOOK.key());
        jsonObject.put(Protocol.EVENT.key(), Protocol.DELETE_EVENT.key());
        jsonObject.put(Protocol.DS.key(), ds);
